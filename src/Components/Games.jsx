        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="flex justify-center gap-10 my-5 mr-20">
            <p className="font-bold text-base-content">
              {animalState.isHungry ? "🔴" : "🟢"} <span className="ml-2">Hungry</span>
            </p>
            <p className="font-bold text-base-content">
              {animalState.isThirsty ? "🔴" : "🟢"} <span className="ml-2">Thirsty</span>
            </p>
            <p className="font-bold text-base-content">
              {animalState.isDirty ? "🔴" : "🟢"} <span className="ml-2">Dirty</span>
            </p>
            <p className="font-bold text-base-content">
              {animalState.hasWaste ? "🔴" : "🟢"} <span className="ml-2">hasWaste</span>
            </p>
          </div>
